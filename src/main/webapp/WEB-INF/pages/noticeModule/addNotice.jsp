...
<div class="mainbar">
    ...
    <div class="page-head">
        ...
        <h2 class="pull-left">
            <!-- page meta -->
            <span class="page-meta">公告添加</span>
        </h2>


        <!-- Breadcrumb -->
        <div class="bread-crumb pull-right">
            <a href="${ctx}/index" target="_top"><i class="icon-home"></i>公告管理</a>
            <!-- Divider -->
                            ...
                            <div class="padd">
                                ...
                                <form class="form-horizontal" role="form" id="addForm">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <label class="col-lg-1 control-label">系别</label>
                                        <div class="col-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="userName" placeholder="公告标题">
                                        </div>
                                    </div>
